...
<head>
    ...
    <title>Mlml Website  - Bulk Join</title>
                                	...
                                	<tr>
                                        ...
                                        <th>
                                            <select name="username" id="pinlist"  class="form-control" >
                                                ...
                                                <?php 
                                                    $pin_user=mysqli_query($con,"Select count(*) AS id, userid from pin_list where status = 'open' AND userid='$userid' ");
