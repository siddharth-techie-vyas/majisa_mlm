            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-3">
                    	<div class="panel panel-success">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Company Level</h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
								echo  get_company_level($con);
								?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                    	<div class="panel panel-primary">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Total No of Active User </h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
                    ...
                    <div class="col-lg-3">
                    	<div class="panel panel-danger">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Total No of In-Active User </h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
                    ...
                    <div class="col-lg-3">
                    	<div class="panel panel-info">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Total Active User(s) Income</h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
								$active = mysqli_query($con,"select COUNT(id) as count from tree");
								$active_row=mysqli_fetch_array($active);
								if(COUNT($active_row) > 0)
								{echo $count = $active_row['count']*20;}
								?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                    	<div class="panel panel-warning">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Total Slab Income</h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
								echo  get_total_slab_income($con);
								?>
                            </div>
                        </div>
                    </div>
