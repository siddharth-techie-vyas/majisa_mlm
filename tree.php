...
<h4 class="panel-title">You Added In Company At</h4>
</div>
<div class="panel-body">
<?php 
echo  get_user_tree_level($con,$_SESSION['userid']);
?>
</div>
</div>
</div>
...
<div class="panel-body">
<?php 
//echo  get_user_active_user($con,$_SESSION['userid']);
?>
</div>
</div>
</div>
...
<div class='col-sm-7'>
    ...
    ?>
        ...
        <!--<a href='tree-total.php' class='btn btn-info btn-sm'>View All Member Under</a>-->
        <?php }
