                ...
                <div class="row">
					...
					<div class="col-lg-3">
                    	<div class="panel panel-primary">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Company Current Level</h4>
                            </div>
					...
					<div class="col-lg-3">
                    	<div class="panel panel-warning">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Add From Company @</h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
                            	$userpin=str_replace("M",'',$_SESSION['userid']);
							echo	$treeuser = get_user_tree_level($con,$userpin);
								//echo $tree['current_level'].' Level';
								?>
                            </div>
                        </div>
                    </div>
					<div class="col-lg-3">
                    	<div class="panel panel-warning">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Your Level</h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
								$user = get_user($con,$_SESSION['userid']);
								echo $user['current_level'];
								?>
                            </div>
                        </div>
                    </div>
